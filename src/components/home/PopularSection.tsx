...
import { usePopularDocuments } from "@/hooks/use-documents";
import { DocumentCard } from "@/components/document/DocumentCard";
import { Skeleton } from "@/components/ui/skeleton";

export function PopularSection() {
  const { data: docs, isLoading } = usePopularDocuments(6);
    ...
    <section className="px-4 py-12">
      <div className="mx-auto max-w-6xl">
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-2xl font-bold text-gray-900">Documents populaires</h2>
          <div className="flex items-center gap-2">
            ...
            <Link href="/browse?sort=popular" className="group inline-flex items-center gap-1 text-sm font-semibold text-purple-600 transition-colors hover:text-purple-800">
